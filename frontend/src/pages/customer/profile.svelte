<script>
    ...
    import { getProfilePicApi, getUserProfileApi, updateApi } from '../../functions/apiCalls';
    let user = {};
    ...
    const getProfilePic = async() => {
        const imgUrl = await getProfilePicApi();
        console.log(imgUrl);
...
<div class="profile"> 
    ...
    <div class="profile__grid">
        <div class="profile__image">
            ...
            <input type="file" accept=".jpg, .jpeg, .png" on:change={(e) => updateProfilePic(e)}>
        </div>
